																     ...
																     \item $2ab$
																		 ...
																		 \begin{enumerate}
																		     \item it passes through the origin
																				 ...
																				 \begin{enumerate}
																				 \item Let f be a function defined on $R$ \brak{the set of all real numbers} such that $f'\brak{x}$=2010$\brak{x-2009}$$\brak{x-2010}^2$$\brak{x-2011^3}$ $\brak{x-2012^4}$ for all x $\in R$ \\ If g is a function defined on $R$ with values in the interval $\brak{0,\infty}$ such that \\
